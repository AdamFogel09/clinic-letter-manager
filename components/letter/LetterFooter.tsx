  ...
  return (
    <div className="letter-footer-bar" style={{
      ...
      <div style={{ flexShrink: 0 }}>
        <p style={{ fontSize: 11, color: "#3A1E72", fontWeight: 400, margin: "0 0 2px", lineHeight: 1.6, letterSpacing: "0.01em" }}>
          Israel Medical Licence 1-143320
        </p>
        <p style={{ fontSize: 11, color: "#3A1E72", fontWeight: 400, margin: "0 0 2px", lineHeight: 1.6, letterSpacing: "0.01em" }}>
          General Medical Council (UK) Licence 4630182
        </p>
        <p style={{ fontSize: 11, color: "#3A1E72", fontWeight: 400, margin: 0, lineHeight: 1.6, letterSpacing: "0.01em" }}>
