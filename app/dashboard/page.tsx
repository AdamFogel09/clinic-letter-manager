    ...
    <div className="flex-1 pb-10">
      ...
      <div className="px-6 sm:px-8 mb-3">
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl"
          style={{ border: `1px solid ${gmailConnected ? "#D1FAE5" : "#E2E8F0"}`, backgroundColor: gmailConnected ? "#F0FDF4" : "#FAFBFC" }}>
          <svg viewBox="0 0 20 20" fill="none" stroke={gmailConnected ? "#16A34A" : "#94A3B8"}
            strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 flex-shrink-0">
          ...
          {gmailConnected === null ? (
            ...
            <p className="text-xs font-semibold" style={{ color: "#16A34A" }}>Gmail connected — PDF sending is active</p>
          ) : (
            <>
              <p className="text-xs" style={{ color: "#64748B" }}>Gmail not connected — PDF emails cannot be sent</p>
